...
| **04 TSP Policy** | 05 TSPS, 10 End-User Agreement | High-level policy implemented by TSPS; Liability aligned with EULA (eIDAS Art. 13); Incident notification triggers aligned with plan 08 (eIDAS Art. 19(2)). | [DATE] |
